...
public class RookTest {
    ...
    void initialize() {
        ...
        chessboard.putPieceAt(rook, A1);    <1><2><3>
    }
    @Test
    void moveToNonHorizontalOrVerticalSpot() {
...
* Look for code that has comments of // Code Smells. 
* Refactor if you understand why it smells
...
* You have a couple of hours to do this.

## Next Requirement 
++++
<details>
  <summary>Change 1</summary>
  <p>Can you use the Chessboard for a game of Checkers?</p>
...
++++
<details>
  <summary>Change 2 - The Pawn</summary>
  <p>What is different about this piece?</p>
  <p>How does this now work?</p>
</details>
++++
